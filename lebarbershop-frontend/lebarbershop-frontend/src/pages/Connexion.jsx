...
import { connecter, getProfil } from "../api/auth";
...
export default function Connexion() {
  ...
  const soumettre = async (e) => {
    ...
    try {
      ...
      await rafraichirProfil();                // GET /auth/profil/ (alimente AuthContext pour tout le site)

      // Mot de passe temporaire (employé créé par son gestionnaire) :
      // priorité absolue, avant même de déterminer le rôle.
      ...
      // Détermine directement le bon espace (super admin / gestionnaire /
      // caissière / praticien) sans attendre le prochain rendu du
      // RoleProvider (point 6 : renvoi automatique vers l'espace super
      // admin si is_superuser / est_admin_principal).
      const postes = await mesPostes(); // GET /api/v1/employes/?moi=true
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 style={{ fontFamily: "Fraunces, serif", fontSize: 26, color: T.titre }}>LeBarberShop</h1>
          </div>
